...
public class App
{
    ...
    public static void main( String[] args )
    {
      ...
      //XmlTransform.convert(FOLDER_CLEAN, "resources/xml/data-mm.xml");

      XmlTransform.export("resources/xml/data-mm.xml","resources/xsl/reestr.xsl","resources/html/reestr-mm.html");
